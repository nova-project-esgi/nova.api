...
import com.esgi.nova.adapters.exposed.repositories.resource_translations.ResourceTranslationRepository
...
class ResourceTranslationByResourceAndLanguagePersistence @Inject constructor(
...
) : BaseDefaultTranslationPersistence<ResourceTranslationKey<UUID>, ResourceTranslationCmdDto<UUID>, ResourceTranslationEntity, ResourceTranslationDto>(
    repository,
