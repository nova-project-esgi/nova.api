...
import com.esgi.nova.adapters.exposed.repositories.choices_resources.ChoiceResourceByChoiceRepository
...
class ChoiceResourceByChoicePersistence @Inject constructor(
        override val repository: ChoiceResourceByChoiceRepository,
        mapper: ChoiceResourceMapper,
        dbContext: DatabaseContext) : BasePersistence<UUID, ChoiceResourceCmdDto, ChoiceResourceEntity, ChoiceResourceDto>(repository, mapper, dbContext),
