...
import com.esgi.nova.core_api.events.exceptions.ChoiceEventMinimalSizeException
import com.esgi.nova.core_api.events.exceptions.EventChoicesMinimalSizeException
import com.esgi.nova.core_api.events.exceptions.EventTranslationMinimalSizeException
...
class EventAggregate() {
    ...
    private fun updateChoices(cmd: UpdateEventCommand) {
        ...
        if (choicesDeletedIds.size == this.choices.size || cmd.choiceIds.isEmpty()) {
            throw ChoiceEventMinimalSizeException()
        } else {
