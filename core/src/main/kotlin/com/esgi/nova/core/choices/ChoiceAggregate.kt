...
import com.esgi.nova.core.events.EventChoicesMinimalSizeException
import com.esgi.nova.core.resources.ResourceTranslationEntity
...
class ChoiceAggregate() {
    ...
    fun on(event: CreatedChoiceTranslationEvent) {
        this.translations.add(ChoiceTranslationEntity(id = event.translationId, title = event.title, description = event.description))
    }
